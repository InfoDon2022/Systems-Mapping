...
# Page setup
# ---------------------------
st.set_page_config(page_title="Suicide Prevention Systems Mapper", layout="wide")
st.title("Suicide Prevention Systems Mapper — Single-File Workflow")
st.caption("Upload one Excel workbook (Nodes + Edges). Optional: vignettes JSON. Taxonomy & settings are built-in for suicide prevention.")
...
DEFAULT_TAXONOMY = {
    ...
    "synonyms": {
        "Community Prevention": ["Prevention", "Upstream", "Gatekeeper Training", "YMHF", "YMHFA", "QPR", "ASIST"],
        "Treatment & Crisis": ["Crisis", "Crisis Response", "Crisis Stabilization", "Mobile Crisis", "988 Center", "BH Urgent Care", "Emergency Psych", "Crisis Residential"],
        "Primary Care & BH": ["Primary Care", "PCP", "FQHC", "Integrated Care", "Behavioral Health", "Outpatient Clinic"],
        "Postvention": ["Loss Team", "Bereavement", "Survivors of Suicide Loss", "Grief Support", "Postvention Team"],
        "Lethal Means Safety": ["Lethal Means", "Firearm Safety", "Safe Storage", "Lock Distribution", "ED-CALM", "CALM"],
        "Data & QI": ["Data", "Public Health", "QI", "Quality Improvement", "Epidemiology", "SMR", "Suicide Mortality Review"],
        "Peer & Lived Experience": ["Peer Support", "Certified Peer", "Lived Experience", "Warmline"],
        "Hotline/Navigation": ["988", "Lifeline", "Warm Line", "Warmlines", "Navigation", "211", "Help Line"],
        "Faith & Community Support": ["Faith-Based", "Church", "Synagogue", "Mosque", "Temple", "Community Group"],
        "Education/Youth": ["School", "School Counselor", "School Psych", "College", "Campus", "Youth Program"],
        "Law Enforcement": ["Police", "Sheriff", "State Police", "CIT", "Co-Responder"]
    }
}
}
...
DEFAULT_SETTINGS = {
    ...
    "service_thresholds_miles": {
        "crisis_response": 30,
        "outpatient_care": 40,
        "inpatient_stabilization": 60,
        "lethal_means_counseling": 40,
        "peer_support": 40
    }
}
}
...
BUILTIN_VIGNETTES = {
    ...
    "vignettes": [
        {
          "id": "sp_001",
          "title": "Veteran in acute crisis calls 988",
          "persona": "Veteran, recent relationship stress, access to firearm",
          "scenario": "Contacts 988; mobile crisis dispatched; lethal-means counseling; safety planning; warm handoff to outpatient BH.",
          "system_type": "Treatment & Crisis",
          "geography": "Town",
          "preferred_path": ["988", "Mobile Crisis", "Lethal Means Counseling", "Outpatient Clinic", "Peer Support"],
          "observed_path":  ["988", "Mobile Crisis", "Outpatient Clinic"]
        },
        {
          "id": "sp_002",
          "title": "High school student identified by counselor",
          "persona": "16-year-old with PHQ-9 positive and recent bullying",
          "scenario": "School counselor identifies risk; contacts parents; warm handoff to crisis clinic; safety plan; follow-up.",
          "system_type": "Education/Youth",
          "geography": "Town",
          "preferred_path": ["School Counselor","Crisis Clinic","Safety Planning","Peer Support","Follow-up"],
          "observed_path":  ["School Counselor","Crisis Clinic","Follow-up"]
        },
        {
          "id": "sp_003",
          "title": "Rural adult seeks firearm storage options",
          "persona": "Adult in rural county, limited services, firearm in home",
          "scenario": "Primary care screens positive; navigator provides safe storage options; lock distribution; tele-BH connection.",
          "system_type": "Lethal Means Safety",
          "geography": "Rural",
          "preferred_path": ["Primary Care","Navigation","Safe Storage","Tele-BH","Peer Support"],
          "observed_path":  ["Primary Care","Navigation","Tele-BH"]
        },
        {
          "id": "sp_004",
          "title": "Postvention after suicide death",
          "persona": "Family and classmates after a suicide death in the community",
          "scenario": "Loss team activated; school/campus postvention; grief groups; monitoring for contagion; referral pathways.",
          "system_type": "Postvention",
          "geography": "Town",
          "preferred_path": ["Loss Team","School Postvention","Grief Support","Peer Support","Outpatient Clinic"],
          "observed_path":  ["Loss Team","Grief Support"]
        },
        {
          "id": "sp_005",
          "title": "Primary care detects moderate risk during visit",
          "persona": "Adult screened in primary care with suicidal ideation",
          "scenario": "Primary care screening; brief intervention; warm handoff to same-day crisis; follow-up call within 48 hours.",
          "system_type": "Primary Care & BH",
          "geography": "Town",
          "preferred_path": ["Primary Care","Brief Intervention","Same-Day Crisis","Outpatient Clinic","Follow-up"],
          "observed_path":  ["Primary Care","Same-Day Crisis","Follow-up"]
        }
    ]
}
    ]
...
with st.sidebar:
    ...
    st.download_button(
        ...
        data=wb,
        file_name="suicide_mapper_export.xlsx",
